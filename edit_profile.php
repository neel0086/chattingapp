...
<head>
    ...
    <body class="cnt">  
            ...
            ?>                 
              ...
              <section class="edit_ps">
                  ...
                  <label for="update_p">
                      ...
                      <input type="file" name="update_p" id="update_p" class="camera">
                      <div class="status_up">
                          <p>Status</p>
                          <input type="text" name="Bio" placeholder="<?php echo $row['Bio'];?>">
            ...
            <div class="profile_photo">
                ...
                <span>
                <i style="font-size:24px" class="fa">&times;</i>
                </span>
            </div>
    </body>
    <script src="javascript/profile_edit.js"></script>
